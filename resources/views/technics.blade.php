...
@section('content')
    @include('blocks.main_image_block',['mode' => 'slim', 'chapter' => trans('menu.technics')])
        ...
        <div class="content ps-0 pe-0 pt-2 pt-lg-5">
            <div class="buttons row mb-4 justify-content-center justify-content-lg-between">
                ...
                <div class="icons-view col-1 d-none d-lg-flex align-items-center justify-content-end">
                    <img class="icon active me-1" src="{{ asset('images/icon_columns.svg') }}">
                    <img class="icon" src="{{ asset('images/icon_rows.svg') }}">
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="technic-block row">
                                <a href="{{ route('technic',['id' => $technic->id]) }}">
                                    ...
                                    <div class="content col-12 col-md-12 p-0">
                                        <div class="head col-12 col-md-12 p-2">
                                            <h1>{{ $technic->name }}</h1>
                                        ...
                                        <div class="button col-12 col-md-12 p-2">
                                            @include('blocks.button_block',[
