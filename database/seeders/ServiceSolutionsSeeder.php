...
class ServiceSolutionsSeeder extends Seeder
{
    ...
    {
        $data = [
            ['head' => 'Профессиональные инспекции', 'text' => '<p>Компания КОМРЭКС оказывает услуги по проведению профессиональной инспекции вашего оборудования:</p><ul><li>Для оценки текущего технического состояния и необходимого ремонта;</li><li>Для поддержания оборудования в рабочем состоянии, исключения катастрофической дорогостоящей поломки и внепланового длительного простоя.</li></ul><p>Мы предлагаем два вида инспекции: базовая и глубокая/детальная, а также поможем взять пробы масла, сдать их в лабораторию и интерпретировать результаты анализов. В результате вы получите детальный отчет с фото/видео и рекомендациями по ремонту.</p>'],
